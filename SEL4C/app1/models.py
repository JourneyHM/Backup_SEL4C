...
class Progreso(models.Model):
    ...
    filename = models.CharField(max_length=50, null=True, blank=True, verbose_name='Nombre de archivo')
    archivo = models.FileField(default='', upload_to='archivos/', verbose_name='Archivo')
